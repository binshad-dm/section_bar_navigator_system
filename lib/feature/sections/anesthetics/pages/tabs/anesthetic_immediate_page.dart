...
class AnestheticImmediatePage extends StatefulWidget {
  ...
  @override
  State<AnestheticImmediatePage> createState() =>
      _AnestheticImmediatePageState();
}
...
class _AnestheticImmediatePageState extends State<AnestheticImmediatePage> {
  ...
  final TextEditingController changeInAnesthesiaController =
            ...
            child: Wrap(
              ...
              children: [
                _filterCheck(
                  'NPO Status',
                  reviewedNpoStatus,
                  (v) => setState(() => reviewedNpoStatus = v),
                ),
                _filterCheck(
                  'Investigations',
                  reviewedInvestigations,
                  (v) => setState(() => reviewedInvestigations = v),
                ),
                _filterCheck(
                  'Medications',
                  reviewedMedications,
                  (v) => setState(() => reviewedMedications = v),
                ),
              ],
            ),
          ),
                ...
                Row(
                  children: [
                    Checkbox(
                      value: arrangedBlood,
                      onChanged: (v) =>
                          setState(() => arrangedBlood = v ?? false),
                    ),
                    const Text('Blood:'),
            ...
            child: Column(
              ...
              children: [
                _filterCheck(
                  ...
                  (v) => setState(
                    () => checklistIdentityProcedureConsentConfirmed = v,
                  ),
                ),
                _filterCheck(
                  ...
                  (v) => setState(
                    () => checklistMachineMonitorsMedicationChecked = v,
                  ),
                ),
                const SizedBox(height: 8),
                _buildYesNoRow(
                  ...
                  onChanged: (v) =>
                      setState(() => difficultAirwayOrAspirationRisk = v),
                ),
                _buildYesNoRow(
                ...
                _buildYesNoRow(
                  ...
                  onChanged: (v) =>
                      setState(() => hypotensionOrImpairedCoagulation = v),
                ),
              ],
            ),
          ),
